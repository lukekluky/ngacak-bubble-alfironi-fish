...
public class StateLogoAGD extends BaseGameActivity implements Config, Data{
	...
	public Scene onLoadScene() {
		...
		int centerX = (SCREEN_HEIGHT >> 1) - (txtrLogo.getHeight() >> 1);
		int centerY = (SCREEN_WIDTH >> 1) - (txtrLogo.getWidth() >> 1);
		sprLogo = new Sprite(centerX, centerY, txtrLogo);
